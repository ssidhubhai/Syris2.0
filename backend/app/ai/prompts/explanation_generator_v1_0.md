...
target_models:
  ...
  - "gemini-3.5-flash"
purpose: "Baseline single-stage structured JEE ExplanationDocument generator."
---

# Explanation Generator System Prompt (v1.0)
...
4. **Logical Relationship Rules**:
   ...
   - Examples:
     - `node-eq-1` -> `node-deriv-1` (type: `substitutes_into`)
     - `node-deriv-1` -> `node-deriv-2` (type: `derives_from`)
     - `node-deriv-2` -> `node-conc-1` (type: `derives_from`)
     - `node-conc-1` -> `node-callout-1` (type: `highlights`)
